...
object JournalChangesIngestion extends CassandraSchema {
  ...
  def start(
    ...
    val transformLeaders: (ResultAddedEvent) ⇒ ((String, mutable.Buffer[((String, String, String, String, String, String, String, Int, Int, Int, Int, Int, Int, Int, Int, Int, Int, String, String, Date))])) = (event) ⇒ {
      val local = findPeriod
      val intervalsLocal = gameIntervals
      val eventTime = ZonedDateTime.of(
        LocalDateTime
