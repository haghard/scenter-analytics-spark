  ...
  def start(ctx: SparkContext,
    ...
    val transformResult2: (ResultAddedEvent) ⇒ ((String,
      ...
      (periodFinder(intervals.entrySet().iterator(), eventTime),
       ...
       eventTime.getYear,
       eventTime.getMonthValue,
       eventTime.getDayOfMonth,
       event.getResult.getHomeScore,
       event.getResult.getAwayScore,
       event.getResult.getHomeScoreLine,
       event.getResult.getAwayScoreLine)
    }

    val transformResult: (ResultAddedEvent, Long) ⇒ ((String,
                                                      String,
                                                      String,
                                                      Int,
                                                      String,
    ...
    val transformLeaders: (ResultAddedEvent) ⇒ ((String,
                                                 mutable.Buffer[
                                                     ((String,
                                                       String,
                                                       String,
    ...
    val transformPlayers: (ResultAddedEvent) ⇒ ((String,
                                                 mutable.Buffer[
                                                     (String,
                                                      String,
                                                      Date,
