...
object SparkFunctions extends Serializable {
  ...
  val intervals: (scala.collection.mutable.LinkedHashMap[String, String], ZoneId, DateTimeFormatter) ⇒ java.util.LinkedHashMap[Period, String] = (stages, est, pattern) ⇒ {
